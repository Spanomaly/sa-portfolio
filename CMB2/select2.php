...
class PW_CMB2_Field_Select2 {
	...
	public function setup_admin_scripts() {
		...
		wp_register_script( 'pw-select2', get_template_directory_uri().'/js/select2.min.js', array( 'jquery-ui-sortable' ), '4.0.3' );
		wp_enqueue_script( 'pw-select2-init', get_template_directory_uri().'/js/script.js', array( 'cmb2-scripts', 'pw-select2' ), self::VERSION );
		wp_register_style( 'pw-select2', get_template_directory_uri().'/css/select2.min.css', array(), '4.0.3' );
		wp_enqueue_style( 'pw-select2-tweaks', get_template_directory_uri().'/css/style.css', array( 'pw-select2' ), self::VERSION );
	}
}
